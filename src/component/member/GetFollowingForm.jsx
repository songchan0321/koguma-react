...
import {getBlockAPI, deleteBlockAPI, deleteFollowingAPI, getFollowingAPI} from '../../apis/api/member';
...
const GetFollowingForm = () => {
    ...
    const handleUnfollowing = async () => {
        ...
        try {
            ...
            await openModal("팔로우를 취소했습니다!", true, () => {navigate('/member/relationship/following/list');});
        ...
        <ThemeProvider theme={theme}>
            <div style={{ textAlign: 'center' }}>
                {loading ? (
                    ...
                    <div>
                        <Modal />
                        <img src={getFollowing.targetMember.profileURL} alt="" style={{
                            width: "8rem",
                            height: "8rem",
                            marginTop: "100px",
                            clipPath: 'circle(50% at 50% 50%)',
                        }} />
                        <Typography variant="h6" gutterBottom style={{ marginTop: '40px', fontWeight: 'bold', fontSize: '1.5rem' }}>
                        ...
                        <Button variant="contained" color="primary" onClick={handleOpen} style={{ marginTop: '20px', backgroundColor: '#D070FB' }}>
                            팔로우 취소
                        </Button>
                        <Back />
